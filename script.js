...
document.querySelector('#darkMode').addEventListener('click', () => {
  ...
  document.querySelector('#timer-digit').classList.toggle('change');
})
    ...
    testing: function(){
      ...
      for(let i=0 ; i<allAlarms.length; i++){
        if(isNaN(allAlarms[i].value)){
          ...
          html.innerHTML +=`<p class="alarm-1" style = "color: rgb(139, 137, 137);">You have set an alarm for ${alarm}</p>`
